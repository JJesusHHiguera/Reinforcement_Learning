...
if __name__ == "__main__":
    ...
    print("Tamaño de entrada:", env.observation_space.shape[0])
    ...
    def validate(engine: Engine):
        ...
        path_regular = saves_path / f"model-{args.run}-{engine.state.iteration}.dat"
        torch.save(net.state_dict(), path_regular)
        print(f"Modelo guardado en: {path_regular}")
